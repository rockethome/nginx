...
Source8: 50x.html
Source9: 404.html
Source100: modsecurity-2.8.0.tar.gz
Source101: headers-more-nginx-module-v0.25.tar.gz
Source102: requestid.tar.gz
...
%{__install} -m 644 -p %{SOURCE8} \
   $RPM_BUILD_ROOT%{_datadir}/nginx/html/
...
%{__mkdir} -p $RPM_BUILD_ROOT%{_sysconfdir}/nginx/vhosts.d
%{__mkdir} -p $RPM_BUILD_ROOT%{_sysconfdir}/nginx/conf.d
%{__rm} $RPM_BUILD_ROOT%{_sysconfdir}/nginx/nginx.conf
%{__install} -m 644 -p %{SOURCE4} \
   $RPM_BUILD_ROOT%{_sysconfdir}/nginx/nginx.conf
%{__install} -m 644 -p %{SOURCE5} \
   $RPM_BUILD_ROOT%{_sysconfdir}/nginx/vhosts.d/default.conf
...
%config(noreplace) %{_sysconfdir}/nginx/vhosts.d/default.conf
...
%changelog
* Thu Apr 17 2014 Mike Mackintosh <m@rocketho.me>
- 1.4.7 patched
- with modsecurity 2.8.0
